        ...
        public static bool Player()
        {
            ...
            switch (Console.ReadLine()) // Read input and case it or reject it
            {
                case "1": // If 1 is entered, will point to the number 1 program
                    ...
                    Console.Clear();
                    Console.WriteLine($"The playlist {_list1.Name} is {_list1.TotalLenghtFormated} and contain :\n");
                    Console.WriteLine($"{_list1}");
                    EndOfFunction("Press enter to return to selector");
                    return true;
                case "2": // If 2 is entered, will point to the number 2 program
                    Console.Clear();
                    Console.WriteLine($"The playlist {_list2.Name} is {_list2.TotalLenghtFormated} and contain :\n");
                    Console.WriteLine($"{_list2}");
                    EndOfFunction("Press enter to return to selector");
                    return true;
                case "3": // If 1 is entered, will point to the number 1 program
                    Console.Clear();
                    Console.WriteLine($"The playlist {_list3.Name} is {_list3.TotalLenghtFormated} and contain :\n");
